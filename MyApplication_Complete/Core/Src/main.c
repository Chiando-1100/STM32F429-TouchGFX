...
/* Definitions for gui_msg_q */
osMessageQueueId_t gui_msg_qHandle;
const osMessageQueueAttr_t gui_msg_q_attributes = {
  .name = "gui_msg_q"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* creation of gui_msg_q */
  gui_msg_qHandle = osMessageQueueNew (16, sizeof(uint16_t), &gui_msg_q_attributes);
